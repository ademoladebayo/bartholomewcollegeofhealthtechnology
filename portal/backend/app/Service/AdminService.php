...
class AdminService
{
    ...
    public function createStudent(Request $request)
    {
        ...
        $studentModel->student_phone =  $request->student_phone;
        ...
        $studentModel->department =  $request->department;
    ...
    public function uploadStudentImage(Request $request)
    {
        if ($request->hasFile('file')) {
            ...
            $storage_path =  $request->file->storeAs('public/fileupload/student-image', $request->student_id . ".png");
            $file_url = '/storage/fileupload/student-image' . $request->student_id . ".png";

            return response()->json(['success' => true, 'message' => 'Upload was', 'url' => $file_url]);
        } else {
