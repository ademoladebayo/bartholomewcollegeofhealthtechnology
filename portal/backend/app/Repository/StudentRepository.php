...
class StudentRepository
{
    ...
    public function createStudent(StudentModel $studentModel)
    {
        ...
        $studentModel->password =  hash::make(strtolower($studentModel->last_name));
        $studentModel->save();
        return response()->json(['success' => true, 'message' => 'Student was created successfully. Your default password is your lastname.']);
    }
